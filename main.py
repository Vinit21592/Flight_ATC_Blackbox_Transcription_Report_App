...
def generate_docx(result):
    doc = Document()
    doc.add_heading('ATC Blackbox Transcription Report', 0)
            ...
            with col2:
                ...
                with st.spinner("Processing"):
                    ...
                    clean_transcription_task = Task(
                        description='Read the transcription from an ATC Blackbox {transcript}, clean it, and create a conversation flow.',
                    ...
                    download_link = get_download_link(docx_file, "Detailed_incident_investigation_report.docx")
